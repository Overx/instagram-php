...
class Constants
{
    ...
    const IG_VERSION = '169.1.0.29.135';
    const VERSION_CODE = '262886998';
    ...
    // Endpoint Constants.
    const BLOCK_VERSIONING_ID = '0e00f30ed0184b9c914a8baad3fe538aa36a9f0faad173486e76af5ee9310d0b';
    ...
    const SUPPORTED_CAPABILITIES = [
        [
            ...
            'value'   => '66.0,67.0,68.0,69.0,70.0,71.0,72.0,73.0,74.0,75.0,76.0,77.0,78.0,79.0,80.0,81.0,82.0,83.0,84.0,85.0,86.0,87.0,88.0,89.0,90.0,91.0,92.0,93.0,94.0,95.0,96.0,97.0,98.0,99.0,100.0,101.0,102.0,103.0,104.0',
        ],
        [
    ...
    const IG_WEB_APPLICATION_ID = '1217981644879628';
    const WEB_CLIENT_TOKEN = '65a937f07619e8d4dce239c462a447ce';
    // IG_WEB_APPLICATION_ID|WEB_CLIENT_TOKEN
    const WEB_ANALYTICS_ACCESS_TOKEN = '1217981644879628|65a937f07619e8d4dce239c462a447ce';

    const X_IG_WWW_CLAIM = 'hmac.AR3VWu1WbtgZTYm1LI-JdffO71nek5ezN2CM-bQ6iN6n1Dka';

    // iOS API constants
    // Instagram 160.1.0.31.120 (iPhone10,2; iOS 13_5_1; en_US; en-US; scale=2.61; 1080x1920; 246979827)
    const IG_IOS_VERSION      = '167.0.0.18.114';
    const IOS_VERSION         = '13_5_1';
    const IOS_MODEL           = 'iPhone10,2';
    const IOS_DPI             = '1080x1920';
    const IOS_SCALE           = '2.61';
    const IG_IOS_VERSION_CODE = '257196069';
